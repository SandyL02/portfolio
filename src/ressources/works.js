...
const data = [
...

  {
    ...
    "issues": "Avant de faire cette formation, il était requis d'avoir au moins suivi la formation HTML et la formation CSS sur le site OpenClassrooms, donc je n'étais pas dépaysée et n'ai pas rencontré de problèmes particuliers."
  },
  {
    "id": "2",
    ...
    "issues": "J'avais déjà suivi la formation JavaScript avant la formation, néanmoins JavaScript est un langage beaucoup plus complexe que HTML et CSS donc j'ai demandé énormément de conseils à mon mentor."
  },
  {
    "id": "3",
    "title": "Front-end du site Kasa",
    "background": "https://raw.githubusercontent.com/SandyL02/portfolio/master/src/images/background_kasa3.png",
    ...
    "issues": "React est difficile à prendre en main, mais une fois maîtrisé, c'est tellement plus rapide !"
  },
  {
    "id": "4",
    ...
    "issues": "Tout ce qui est côté back-end m'effrayait, je préfère toujours le front mais désormais je connais le back également."
  }
]
